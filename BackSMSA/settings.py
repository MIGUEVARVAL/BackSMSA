"""
Django settings for BackSMSA project.
...
SECRET_KEY = 'django-insecure-z3x5%%tn)#oyl=wunv-(q)3(h@fj_mhkxqy0y!dtn7gcyz*e9@'
...
WSGI_APPLICATION = 'BackSMSA.wsgi.application'
